...
// Code adapted from: http://androidtrainingchennai.blogspot.com/2011/01/artificial-horizon.html

package org.ospdi.opdi.wizdroyd.portdetails;
...
public class CompassView extends View {
	...
	protected void initCompassView() {
		...
		markerPaint.setShadowLayer(2, 1, 1, Color.GRAY);

		borderGradientColors = new int[4];
		borderGradientPositions = new float[4];

		borderGradientColors[3] = Color.LTGRAY;
		borderGradientColors[2] = Color.LTGRAY;
		borderGradientColors[1] = Color.LTGRAY;
		borderGradientColors[0] = Color.LTGRAY;
		...
		skyHorizonColorFrom = Color.GREEN;
		skyHorizonColorTo = Color.DKGRAY;

		groundHorizonColorFrom = Color.BLACK;
		groundHorizonColorTo = Color.BLUE;
	}
