...
public class ShowPortDetails extends Activity implements IDeviceListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        final String devId = getIntent().getStringExtra(Wizdroyd.CURRENT_DEVICE_ID);
        ...
        new Thread(new Runnable() {
            public void run() {
                ...
                try {
			        ...
			        String portID = getIntent().getStringExtra(Wizdroyd.CURRENT_PORT_ID);
			        device = DeviceManager.getInstance().findDeviceById(devId);
					...
					Log.e(Wizdroyd.MASTER_NAME, "Error", e1);
                	finish();
				}
            }
