...
//    private static final int REQUEST_CONNECT_DEVICE_INSECURE = 2;
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		if (extras != null) {
			String address = extras.getString(Wizdroyd.BT_ADDRESS);
			if (address == null) address = "";
			String name = extras.getString(Wizdroyd.BT_NAME);
			if (name == null) name = address;
			String psk = extras.getString(Wizdroyd.DEVICE_PSK);
			if (psk == null) psk = "";
			String pin = extras.getString(Wizdroyd.BT_PIN);
			if (pin == null) pin = "";
			boolean secure = extras.getBoolean(Wizdroyd.BT_SECURE, false);
        ...
        btnAddDevice.setOnClickListener(new View.OnClickListener() {			
			...
			public void onClick(View v) {
	            ...
	            setResult(Wizdroyd.ADD_BLUETOOTH_DEVICE, result);
