...
import org.ospdi.opdi.wizdroyd.DeviceManager;
...
import org.ospdi.opdi.wizdroyd.portdetails.ShowPortDetails;
...
public class ShowDevicePorts extends LoggingActivity implements IDeviceListener {
 ...
 //                   Log.d(Wizdroyd.MASTER_NAME, "Processing action: " + op.getName());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String devId = getIntent().getStringExtra(Wizdroyd.CURRENT_DEVICE_ID);
	...
	private void showPortDetails(Port port) {
		...
		intent.putExtra(Wizdroyd.CURRENT_DEVICE_ID, device.getId());
		intent.putExtra(Wizdroyd.CURRENT_PORT_ID, port.getID());
