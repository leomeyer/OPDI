 ...
 *
 */
public class TCPIPDevice extends WizdroydDevice {
...
//		Log.d(Wizdroyd.MASTER_NAME, "deserialize: " + ser);
	...
	protected boolean isNetworkAvailable() {
	    ConnectivityManager connectivityManager 
	          = (ConnectivityManager) Wizdroyd.instance.getSystemService(Wizdroyd.CONNECTIVITY_SERVICE);
	...
	public boolean prepare() {
		...
		if (!isNetworkAvailable()) {
			Wizdroyd.instance.runOnUiThread(new Runnable() {
				@Override
				public void run() {
					Toast.makeText(Wizdroyd.instance, ResourceFactory.getInstance().getString(R.string.network_not_available), Toast.LENGTH_SHORT).show();
				}
			});
			return false;
		}
