Raspberry Pi Gertboard plugin for OPDID

This plugins supports most of the Gertboard I/O functions.
See opdid/testconfigs/gertboard_opdid.ini for a detailed description of configuration settings.
...
Serial communication occurs in the OPDID main thread. If serial communication is slow, e. g. if the system load is high, and
